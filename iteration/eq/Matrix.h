...
#ifndef PLAY_WITH_ALGO_ITERATION_EQ_MATRIX_H_
#define PLAY_WITH_ALGO_ITERATION_EQ_MATRIX_H_
#include <vector>
...
class CMatrix {
 public:
  ...
  CMatrix(const CMatrix<T> &m) { *this = m; }
...
#endif //PLAY_WITH_ALGO_ITERATION_EQ_MATRIX_H_
