...
#ifndef DYNAMIC_ARRAY_DS_SET_MAP_LINKEDLIST_LINKEDLIST_H_
#define DYNAMIC_ARRAY_DS_SET_MAP_LINKEDLIST_LINKEDLIST_H_
#include <iostream>
#include <cassert>
...
#endif //DYNAMIC_ARRAY_DS_SET_MAP_LINKEDLIST_LINKEDLIST_H_
