...
#ifndef PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_INDEXMINHEAP_H_
#define PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_INDEXMINHEAP_H_
#include <iostream>
#include <algorithm>
#include <cassert>
...
#endif //PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_INDEXMINHEAP_H_
