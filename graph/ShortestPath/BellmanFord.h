...
#ifndef PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_BELLMANFORD_H_
#define PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_BELLMANFORD_H_
#include <stack>
#include <vector>
#include "Edge.h"
...
#endif //PLAY_WITH_ALGO_GRAPH_SHORTESTPATH_BELLMANFORD_H_
